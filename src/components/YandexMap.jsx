        ...
        <Container maxW={"container.lg"}>
          <Box>
            <Flex gap={"50px"} justifyContent={"space-between"}>
              <Box>
                <Flex alignItems={"start"} justifyContent={"space-between"}>
                  <VStack fontSize={"xxs"} alignItems={"start"}>
                    <Text color={"brand.main"} fontWeight={600}>Телефон</Text>
                    <Link>
                      +7 (999) 478 00 66 <br />
                      +7 (999) 478 00 55
                    </Link>
                  ...
                  <VStack fontSize={"xxs"} alignItems={"start"}>
                    <Text color={"brand.main"} fontWeight={600}>Время работы</Text>
                    <Text>
                      пн-пт 8:00-18:00
                      <br /> сб 9:00-14:00
                    </Text>
                  ...
                  <VStack fontSize={"xxs"} alignItems={"start"}>
                    <Text color={"brand.main"} fontWeight={600}>Адрес</Text>
                    <Text>
                      г. Махачкала, <br />
                ...
                <Text my={"30px"} fontSize={"xxs"} color={"gray.500"}>
                  ...
                  Odit, reiciendis quasi sit, libero earum non sequi vitae
                  cumque nesciunt ullam placeat eveniet maiores asperiores
                  fugiat dolorem quos ad aperiam nobis.
                </Text>
              ...
              <Image src={build} borderRadius={"20px"} w={"40%"} />
            </Flex>
          </Box>
        </Container>
      </Box>
